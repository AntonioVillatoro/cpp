...
void cargarLibros() {
    ...
    libros[31][2] = "Antonio Villatoro";

	libros[32][0] = "Python"; 
    libros[32][1] = "Inmersion en Python 3"; 
    libros[32][2] = "Antonio Villatoro";
    ...
    libros[37][2] = "Antonio Villatoro";

	libros[38][0] = "Python"; 
    libros[38][1] = "Python para todos"; 
    libros[38][2] = "Person, Ron";
}
...
int main(int argc, char const *argv[])
{
    ...
    while (salir == false)
    {
        string buscar = "";
        system("cls");
        cout << "Ingrese la descripcion del libro que busca o bien el autor: ";
        cin >> buscar;
